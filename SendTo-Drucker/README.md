...
* nemo_sendto_printer_wrapper (Bash-Script) - Wird aufgerufen von sendto_printer_office.nemo_action und sendto_printer_pdftxt.nemo_action.
Dieses Script enthält die eigentliche Druckfunktion. Je nach übergebenem Parameter wird die Druckfunktion für Office-Dateien oder für Textdateien
aufgerufen für alle an das Script übergebenen Dateien. Der Wrapper ermöglicht insbesondere für das Drucken der Office-Dateien eine Mehrfachauswahl,
